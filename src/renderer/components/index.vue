...
<el-container>
  <el-header>
      <el-col :span= "4" class="brand">
        <span class="brand-text">步态识别系统</span>
      </el-col>
      <el-col :span= "18">
        <el-row type="flex" justify="end">
            ...
            >
              <el-menu-item index="1" @click= "dialog1Visible = true">视频帧提取</el-menu-item>
              <el-menu-item index="2" @click= "dialog2Visible = true">图像裁剪</el-menu-item>
              <el-menu-item index="3" @click= "dialog3Visible = true">剪影图生成</el-menu-item>
              <el-menu-item index="4" @click= "dialog4Visible = true">特征入库</el-menu-item>
              <el-menu-item index="5" @click= "dialog5Visible = true">步态检索</el-menu-item>
              <el-menu-item index="6" @click= "dialog6Visible = true">步态比对</el-menu-item>
            </el-menu>
        </el-row>
      </el-col>
